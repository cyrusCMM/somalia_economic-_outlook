...
def plot_real_sector_dashboard(indicators, years, save_path=None):
    years_main = [y for y in years if y <= 2024]
    years_cpi = [y for y in years if y <= 2024]
...
def main():
    ...
    real_raw, years = load_sector_sheet(DATA_FILE, SHEET_NAME)
