...
def create_key_indicators_table(ind, years=None):
    rows = {
...
def plot_monetary_dashboard(ind, years, save_path=None, start_year=None, end_year=None):
    ...
    add_table(
        axes[2, 2],
        create_key_indicators_table(ind, years_main),
